                            ...
                            <div class="add_item">
                                ...
                                <div class="delete_extra_item" id="delete_extra_item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <h5>Add Student Fee Amount<span class="text-danger">*</span></h5>
                                                <div class="controls">
                                                    <input type="text" name="amount[]" value="{{$edit->amount}}" class="form-control" aria-invalid="false">
                                                </div>
                                            </div>
                                        </div>
           ...
           <div class="form-row">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        <h5>Add Student Fee Amount<span class="text-danger">*</span></h5>
                        <div class="controls">
                            <input type="text" name="amount[]" class="form-control" aria-invalid="false">
                        </div>
                    </div>
                </div>
                <div class="col-md-2" style="padding-top: 25px;">
