...
class StudentRollController extends Controller
{
    public function StudentRollView(){
        ...
        return view('backend.student.roll_genarate.roll_genarate_view',$data);
    }
    ...
    public function StudentRollUpdate(Request $request){
        ...
        $notification = array(
            'message' => 'Well Done Roll Generated Sussessfully',
            'alert-type'=> 'success'
          );
